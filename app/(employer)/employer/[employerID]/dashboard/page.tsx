...
import { ArrowRight, Briefcase, Building2, FileText, Target, Users } from 'lucide-react';

const OVERVIEW = [
  { label: 'Active roles', value: '—', icon: Briefcase, href: (id: string) => `/employer/${id}/roles` },
  { label: 'Open postings', value: '—', icon: FileText, href: (id: string) => `/employer/${id}/postings` },
  { label: 'Candidates matched', value: '—', icon: Target, href: (id: string) => `/employer/${id}/matches` },
  { label: 'Organization members', value: '—', icon: Users, href: (id: string) => `/employer/${id}/org/members` },
] as const;
          ...
          <CardContent className="space-y-3">
            ...
            <div className="rounded-lg border p-4">
              ...
              <div className="mt-1 text-sm text-muted-foreground">
                Improve match quality by keeping role requirements specific and evidence-driven.
              </div>
            </div>
          </CardContent>
        </Card>
